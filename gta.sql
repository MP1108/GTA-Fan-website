...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 22, 2026 at 10:22 PM
...
(18, 'Combat Pistol', 'cos', '', 60),
(19, 'Special Carbine', 'Karabin', 'Mocniejszy karabin z dobrą szybkostrzelnością i stabilnością.', 10),
...
--
-- Struktura tabeli dla tabeli `napady`
--
...
(1, 'Napad na Fleeca Bank', 'Los Santos', 500000.00, '<p>Pierwszy napad dostępny w GTA Online.</p>', 1),
(2, 'Napad na Pacific Standard', 'Centrum Los Santos', 1250000.00, 'Jeden z największych napadów.', 2);

-- --------------------------------------------------------

--
-- Struktura tabeli dla tabeli `napad_bron`
--
...
--
-- Struktura tabeli dla tabeli `napad_postac`
--
...
--
-- Struktura tabeli dla tabeli `pojazdy_specjalne`
--
...
--
-- Indeksy dla tabeli `napad_postac`
--
...
--
-- Indeksy dla tabeli `pojazdy_specjalne`
--
